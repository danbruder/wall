...
{
	if (region.aB.T === region.aL.T)
	{
		return 'on line ' + region.aB.T;
	}
	return 'on lines ' + region.aB.T + ' through ' + region.aL.T;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aN: fragment, aR: host, aZ: path, a$: port_, a2: protocol, az: query};
	});
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {C: frag, bW: params, B: unvisited, x: value, F: visited};
	});
...
var $author$project$Pages$NotFound$page = $author$project$Spa$Page$static(
	{b9: $author$project$Pages$NotFound$view});
...
var $author$project$Pages$Top$page = $author$project$Spa$Page$static(
	{b9: $author$project$Pages$Top$view});
...
var $author$project$Pages$Wall$init = function (_v0) {
	var params = _v0.bW;
	return _Utils_Tuple2(
		{ac: false, G: '', U: _List_Nil},
		$elm$core$Platform$Cmd$none);
};
var $author$project$Pages$Wall$Connected = function (a) {
	return {$: 3, a: a};
};
var $author$project$Pages$Wall$Disconnected = function (a) {
	return {$: 4, a: a};
};
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$author$project$Pages$Wall$connected($author$project$Pages$Wall$Connected),
				$author$project$Pages$Wall$disconnected($author$project$Pages$Wall$Disconnected)
			]));
};
			...
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{G: ''}),
					$author$project$Pages$Wall$sendMessage(model.G));
			case 2:
				var message = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Pages$Wall$Send = {$: 1};
...
var $author$project$Pages$Wall$page = $author$project$Spa$Page$element(
	{bF: $author$project$Pages$Wall$init, b2: $author$project$Pages$Wall$subscriptions, b7: $author$project$Pages$Wall$update, b9: $author$project$Pages$Wall$view});
	...
	function (params, key, url) {
		return {
			...
			az: A2(
				$elm$core$Maybe$withDefault,
				$elm$core$Dict$empty,
				A2($elm$core$Maybe$map, $author$project$Spa$Url$toQueryDict, url.az)),
			a3: url
		};
	});
...
var $author$project$Spa$Generated$Pages$upgrade = F3(
	function (toModel, toMsg, page) {
			...
			function (params, shared) {
				return A3(
					...
					A2(
						page.bF,
						shared,
						A3($author$project$Spa$Url$create, params, shared.bG, shared.b8)));
			});
		...
		return {P: bundle_, bF: init_, b7: update_};
	});
...
var $author$project$Spa$Generated$Pages$init = function (route) {
	switch (route) {
		case 0:
			return $author$project$Spa$Generated$Pages$pages.ao.bF(0);
		case 1:
			return $author$project$Spa$Generated$Pages$pages.ai.bF(0);
		default:
			return $author$project$Spa$Generated$Pages$pages.ap.bF(0);
	}
};
var $author$project$Spa$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		case 0:
			...
			return $author$project$Spa$Generated$Pages$pages.ao.P(model);
		case 1:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.ai.P(model);
		default:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.ap.P(model);
	}
};
...
var $author$project$Spa$Generated$Pages$subscriptions = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).b2(0);
};
			...
			switch (_v0.a.$) {
				case 0:
					if (!_v0.b.$) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.ao.b7, msg, model);
					} else {
						break _v0$3;
					}
				case 1:
					if (_v0.b.$ === 1) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.ai.b7, msg, model);
					} else {
						break _v0$3;
					}
				default:
					if (_v0.b.$ === 2) {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.ap.b7, msg, model);
					} else {
						break _v0$3;
					}
			}
...
var $author$project$Spa$Generated$Pages$view = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).b9(0);
};
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		bS: $author$project$Main$UrlChanged,
		bT: $author$project$Main$LinkClicked,
		b2: $author$project$Main$subscriptions,
		b7: $author$project$Main$update,
		b9: A2($elm$core$Basics$composeR, $author$project$Main$view, $author$project$Spa$Document$toBrowserDocument)
	});
