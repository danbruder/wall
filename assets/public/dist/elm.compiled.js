...
var $author$project$Pages$Top$GotExistingMessages = function (a) {
	return {$: 'GotExistingMessages', a: a};
};
...
var $author$project$Pages$Top$init = function (_v0) {
	var params = _v0.params;
	return _Utils_Tuple2(
		{connected: false, draft: '', messages: _List_Nil, offlineMessages: _List_Nil, uploadedUrls: _List_Nil, users: _List_Nil},
		$author$project$Pages$Top$getExisting);
};
var $author$project$Pages$Top$Connected = {$: 'Connected'};
var $author$project$Pages$Top$Disconnected = {$: 'Disconnected'};
...
var $author$project$Pages$Top$dropUserMsgs = function (message) {
	if ((message.$ === 'Just') && (message.a.$ === 'GotUsers')) {
		return $elm$core$Maybe$Nothing;
	} else {
		var msg = message;
	...
	function (message, model) {
		if (message.$ === 'Just') {
			switch (message.a.$) {
				...
				case 'NewUploadMessage':
					var uploads = message.a.a;
					return _Utils_update(
						model,
						{
							uploadedUrls: _Utils_ap(model.uploadedUrls, uploads)
						});
				default:
	...
	return $elm$http$Http$request(
		{
			body: $elm$http$Http$multipartBody(
				A2(
					...
					files)),
			expect: $elm$http$Http$expectWhatever($author$project$Pages$Top$UploadedFile),
			headers: _List_Nil,
			method: 'POST',
		...
		switch (msg.$) {
			case 'DraftChanged':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'Send':
				return model.connected ? _Utils_Tuple2(
					_Utils_update(
						model,
						{draft: ''}),
					$author$project$Pages$Top$sendMessage(model.draft)) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							draft: '',
							offlineMessages: _Utils_ap(
								model.offlineMessages,
								_List_fromArray(
									[model.draft]))
						}),
					$elm$core$Platform$Cmd$none);
			case 'GotExistingMessages':
				var response = msg.a;
				if (response.$ === 'Ok') {
			...
			case 'GotMessage':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'Connected':
				var cmds = A2($elm$core$List$map, $author$project$Pages$Top$sendMessage, model.offlineMessages);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{connected: true, offlineMessages: _List_Nil}),
...
var $author$project$Pages$Top$ClickedSelectFiles = {$: 'ClickedSelectFiles'};
var $author$project$Pages$Top$DraftChanged = function (a) {
	return {$: 'DraftChanged', a: a};
};
var $author$project$Pages$Top$Send = {$: 'Send'};
							...
							[
								...
								_List_fromArray(
									[
										...
										A2($elm$core$List$map, $author$project$Components$Chat$viewMessage, config.messages))
									]))
							])),
						A2(
						$elm$html$Html$div,
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Events$onSubmit(config.handleSubmit)
													]),
												_List_fromArray(
													[
														A2(
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$elm$html$Html$Events$onInput(config.handleInput),
																		$elm$html$Html$Attributes$value(config.draft),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$core$List$map, $author$project$Components$Gallery$viewPhoto, config.urls))
			]));
};
					...
					[
						...
						_List_fromArray(
							[
								...
								{draft: model.draft, handleInput: $author$project$Pages$Top$DraftChanged, handleSubmit: $author$project$Pages$Top$Send, messages: model.messages})
							]))
					]))
			]),
		title: 'Wall'
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Pages.NotFound.Msg":{"args":[],"type":"Basics.Never"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"Shared":["Shared.Msg"],"Pages":["Spa.Generated.Pages.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Shared.Msg":{"args":[],"tags":{"ReplaceMe":[]}},"Spa.Generated.Pages.Msg":{"args":[],"tags":{"Top__Msg":["Pages.Top.Msg"],"NotFound__Msg":["Pages.NotFound.Msg"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Pages.Top.Msg":{"args":[],"tags":{"DraftChanged":["String.String"],"UploadedFile":["Result.Result Http.Error ()"],"SelectedFiles":["File.File","List.List File.File"],"ClickedSelectFiles":[],"Send":[],"GotMessage":["Maybe.Maybe Pages.Top.Message"],"GotExistingMessages":["Result.Result Http.Error (List.List (Maybe.Maybe Pages.Top.Message))"],"Connected":[],"Disconnected":[]}},"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"File.File":{"args":[],"tags":{"File":[]}},"List.List":{"args":["a"],"tags":{}},"Pages.Top.Message":{"args":[],"tags":{"ChatMessage":["String.String"],"NewUploadMessage":["List.List String.String"],"GotUsers":["List.List String.String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}}}})}});}(this));