...
var $author$project$Spa$Generated$Route$Wall = {$: 'Wall'};
...
var $author$project$Spa$Generated$Route$routes = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Spa$Generated$Route$Wall,
...
var $author$project$Pages$Wall$init = function (_v0) {
	var params = _v0.params;
	return _Utils_Tuple2(
		{connected: false, draft: '', messages: _List_Nil, offlineMessages: _List_Nil},
		$elm$core$Platform$Cmd$none);
};
var $author$project$Pages$Wall$Connected = {$: 'Connected'};
var $author$project$Pages$Wall$Disconnected = {$: 'Disconnected'};
		...
		switch (msg.$) {
			...
			case 'Send':
				return model.connected ? _Utils_Tuple2(
					_Utils_update(
						model,
						{draft: ''}),
					$author$project$Pages$Wall$sendMessage(model.draft)) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							draft: '',
			...
			case 'Recv':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'Connected':
				var cmds = A2($elm$core$List$map, $author$project$Pages$Wall$sendMessage, model.offlineMessages);
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $author$project$Pages$Wall$Send = {$: 'Send'};
...
var $author$project$Pages$Wall$page = $author$project$Spa$Page$element(
	{init: $author$project$Pages$Wall$init, subscriptions: $author$project$Pages$Wall$subscriptions, update: $author$project$Pages$Wall$update, view: $author$project$Pages$Wall$view});
...
var $author$project$Spa$Generated$Pages$pages = {
	...
	wall: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Wall__Model, $author$project$Spa$Generated$Pages$Wall__Msg, $author$project$Pages$Wall$page)
};
var $author$project$Spa$Generated$Pages$init = function (route) {
	switch (route.$) {
		...
		default:
			return $author$project$Spa$Generated$Pages$pages.wall.init(_Utils_Tuple0);
	}
};
var $author$project$Spa$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		...
		default:
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.wall.bundle(model);
	}
};
	...
	function (bigMsg, bigModel) {
		...
		while (true) {
			switch (_v0.a.$) {
				...
				default:
					if (_v0.b.$ === 'Wall__Model') {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.wall.update, msg, model);
					} else {
						break _v0$3;
					}
			}
